...
// // ✅ NEW - common icon options for categories
// const ICON_OPTIONS = [
//   "Box", "Pill", "Tool", "Wrench", "Zap", "Car", "Apple",
//   "Cpu", "Search", "HardHat", "Sparkles", "Shirt", "Carrot",
//   "Factory", "Package", "Layers", "Truck", "Settings",
//   "Droplet", "Leaf", "Flame", "Bolt", "Cog", "Wheat",
// ];
...
//   // ================= HANDLE CHANGE =================
//   const handleChange = (e) => {
//     const { name, value, type, checked } = e.target; // ✅ UPDATED
//     setFormData({
//       ...formData,
...
//       data.append("slug", formData.slug);
//       data.append("desc", formData.desc);
//       data.append("icon", formData.icon);             // ✅ NEW
//       data.append("showOnHome", formData.showOnHome); // ✅ NEW
//       if (image) {
//         data.append("image", image);
//       }
...
//       // RESET
//       setFormData({ name: "", slug: "", desc: "", icon: "Box", showOnHome: false }); // ✅ UPDATED
//       setImage(null);
//       setEditingId(null);
//       fetchCategories();
//     } catch (error) {
...
//       slug: cat.slug,
//       desc: cat.desc,
//       icon: cat.icon || "Box",            // ✅ NEW
//       showOnHome: cat.showOnHome || false, // ✅ NEW
//     });
//     window.scrollTo({ top: 0, behavior: "smooth" });
//   };
...
//               <option key={iconName} value={iconName} className="bg-black">
//                 {iconName}
//               </option>
//             ))}
//           </select>
...
//               React.createElement(LucideIcons[formData.icon], { size: 20 })}
//           </div>
...
//                 <th className="p-4">Category</th>
//                 <th className="p-4">Slug</th>
//                 <th className="p-4">Icon</th> {/* ✅ NEW */}
//                 <th className="p-4">Products</th>
//                 <th className="p-4">Home</th> {/* ✅ NEW */}
//                 <th className="p-4">Status</th>
//                 <th className="p-4">Actions</th>
//               </tr>
//             </thead>
...
//               {categories?.length === 0 && (
//                 <tr>
//                   <td colSpan="8" className="text-center py-10 text-white/40"> {/* ✅ UPDATED colSpan */}
//                     No Categories Found
//                   </td>
//                 </tr>
//               )}
...
export default function Categories() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // RESET
      setFormData({ name: "", slug: "", desc: "", icon: "Box", showOnHome: false });
      setImage(null);
      setEditingId(null);
      fetchCategories();
    } catch (error) {
