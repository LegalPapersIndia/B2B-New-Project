...
import { getAllRequirements, deleteRequirementAdmin, deleteMultipleRequirementsAdmin } from "../../api/requirementApi";
import ConfirmModal from "../../components/common/ConfirmModal";
import AdminDirectLeadsTable from "../../components/enquiries/AdminDirectLeadsTable";
import AdminRequirementsTable from "../../components/enquiries/AdminRequirementsTable";
...
export default function Enquiries() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] text-white p-4 sm:p-6 w-full">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Enquiries Management</h1>
        <p className="text-sm text-white/40 mt-1">Manage all leads and buyer requirements</p>
      </div>
