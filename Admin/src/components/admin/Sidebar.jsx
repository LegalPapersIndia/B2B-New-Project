...
//               {({ isActive }) => (
//                 <>
//                   <span className={`transition-colors ${isActive ? "text-blue-400" : "text-white/30 group-hover:text-white/60"}`}>
//                     {item.icon}
//                   </span>
//                   {item.label}
//                   {item.label === "Sellers" && (
...
//               <div className="text-sm text-slate-200 font-medium truncate">Admin</div>
//               <div className="text-[11px] text-white/30 truncate">admin@b2b.com</div>
//             </div>
