...
import {
  FaBoxOpen, FaUsers, FaPlus, FaArrowUp,
  FaCrown, FaEye, FaChevronRight, FaEnvelope,
} from "react-icons/fa";
import {
...
const planStyle = (plan) => {
  switch (plan) {
    case "gold":    return { bg: "bg-yellow-100", text: "text-yellow-700", border: "border-yellow-200", icon: "⭐" };
    case "premium": return { bg: "bg-purple-100", text: "text-purple-700", border: "border-purple-200", icon: "💎" };
    case "basic":   return { bg: "bg-blue-100",   text: "text-blue-700",   border: "border-blue-200",   icon: "🔵" };
    default:        return { bg: "bg-gray-100",   text: "text-gray-500",   border: "border-gray-200",   icon: "—"  };
  }
};
  ...
  return (
    <main className="flex-1 p-6 overflow-y-auto bg-gray-50">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-xl transition group">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="text-3xl font-bold mt-2 text-gray-800">{totalProducts}</h2>
            </div>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-xl transition group">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="text-3xl font-bold mt-2 text-gray-800">{totalLeads}</h2>
            </div>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-xl transition group">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="text-3xl font-bold mt-2 text-gray-800">{totalRequirements}</h2>
            </div>
        ...
        <div className={`rounded-3xl p-6 shadow-sm border hover:shadow-xl transition group ${plan.bg} ${plan.border}`}>
          <div className="flex items-center justify-between">
            <div>
      ...
      {categoryChartData.length > 0 && (
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
          <div className="xl:col-span-2 bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-lg font-bold text-gray-800 mb-1">Products by Category</h2>
            <p className="text-sm text-gray-400 mb-5">Distribution across categories</p>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-lg font-bold text-gray-800 mb-1">Product Status</h2>
        ...
        <div className="xl:col-span-2 bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-sm text-gray-500">Your latest added products</p>
            </div>
            <Link to="/seller/products" className="text-[#1447E6] font-medium text-sm flex items-center gap-1 hover:gap-2 transition-all">
                    ...
                    <tr key={p._id} className="hover:bg-gray-50 transition">
                      <td className="py-3 font-medium text-gray-800">
                        <div className="flex items-center gap-3">
                          {p.images?.[0]?.url && (
                            <img src={p.images[0].url} alt={p.title} className="w-10 h-10 rounded-xl object-cover" />
                          )}
                      ...
                      <td className="py-3 font-semibold text-gray-800">₹{p.price?.toLocaleString()}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-3">
              <Link to="/seller/add-product" className="w-full bg-[#1447E6] hover:bg-blue-700 text-white py-3 rounded-2xl font-medium transition flex items-center justify-center gap-2">
                <FaPlus /> Add New Product
              </Link>
              <Link to="/seller/leads" className="w-full bg-[#F54900] hover:bg-[#d63f00] text-white py-3 rounded-2xl font-medium transition flex items-center justify-center gap-2">
                <FaUsers /> View Leads
              </Link>
              <Link to="/seller/profile" className="w-full border border-gray-300 hover:border-[#1447E6] hover:text-[#1447E6] py-3 rounded-2xl font-medium transition flex items-center justify-center gap-2">
                Edit Profile
              </Link>
            </div>
          </div>
                  ...
                  <div className="space-y-3">
                    {requirements.slice(0, 4).map((r, i) => (
                      <div key={i} className="flex items-start gap-3 p-3 rounded-2xl bg-gray-50 hover:bg-green-50 transition">
                        ...
                        <div className="min-w-0">
                          <p className="font-semibold text-gray-800 text-sm line-clamp-1">{r.productName}</p>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-6 text-white">
            ...
            <Link to="/seller/profile" className="mt-4 inline-block bg-white text-orange-600 px-4 py-2 rounded-xl text-sm font-semibold hover:bg-orange-50 transition">
              Complete Profile →
            </Link>
          </div>
