...
//     categoryMap[name] = (categoryMap[name] || 0) + 1;
//   });
//   const categoryChartData = Object.entries(categoryMap).map(([name, count]) => ({ name, count }));
...
//   // ── SUBSCRIPTION EXPIRY CHECK ──
//   const expireDate = profile?.subscriptionExpire ? new Date(profile.subscriptionExpire) : null;
...
//       {/* ── SUBSCRIPTION WARNING BANNER ── */}
//       {daysLeft !== null && daysLeft <= 7 && daysLeft > 0 && (
//         <div className="bg-orange-50 border border-orange-200 text-orange-700 px-4 py-3 rounded-2xl mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
//           <span className="text-sm">⚠️ Your subscription is expiring in <strong>{daysLeft} day{daysLeft > 1 ? "s" : ""}</strong>! Renew now to keep your products live.</span>
//           <Link to="/seller/subscription" className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-1.5 rounded-xl text-sm font-semibold transition whitespace-nowrap w-fit">
//             Renew Now
//           </Link>
//         </div>
//       )}
...
//       {daysLeft !== null && daysLeft <= 0 && (
//         <div className="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-2xl mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
//           <span className="text-sm">❌ Your subscription has expired! Your products are no longer visible to buyers.</span>
//           <Link to="/seller/subscription" className="bg-red-500 hover:bg-red-600 text-white px-4 py-1.5 rounded-xl text-sm font-semibold transition whitespace-nowrap w-fit">
//             Subscribe Now
//           </Link>
//         </div>
//       )}
...
//         <Link
//           to="/seller/add-product"
//           className="bg-[#F54900] hover:bg-[#d63f00] text-white px-5 py-3 rounded-2xl font-semibold flex items-center gap-2 transition shadow-md hover:shadow-lg w-fit text-sm sm:text-base"
//         >
//           <FaPlus /> Add Product
//         </Link>
//       </div>
...
//         <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-sm border border-gray-100 hover:shadow-xl transition group">
//           <div className="flex items-center justify-between">
//             <div>
//               <p className="text-xs sm:text-sm text-gray-500">Total Products</p>
//               <h2 className="text-2xl sm:text-3xl font-bold mt-1 sm:mt-2 text-gray-800">{totalProducts}</h2>
//             </div>
//             <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-orange-100 flex items-center justify-center group-hover:scale-110 transition">
//               <FaBoxOpen className="text-[#F54900] text-lg sm:text-2xl" />
//             </div>
//           </div>
//           <div className="flex items-center gap-1 sm:gap-2 mt-3 sm:mt-5 text-green-600 text-xs sm:text-sm font-medium">
//             <FaArrowUp /> {approvedProducts} approved
//           </div>
//         </div>
...
//           <div className="flex items-center justify-between">
//             <div>
//               <p className="text-xs sm:text-sm text-gray-500">Inquiries</p>
//               <h2 className="text-2xl sm:text-3xl font-bold mt-1 sm:mt-2 text-gray-800">{totalLeads}</h2>
//             </div>
//             <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-blue-100 flex items-center justify-center group-hover:scale-110 transition">
//               <FaUsers className="text-[#1447E6] text-lg sm:text-2xl" />
//             </div>
//           </div>
//           <div className="flex items-center gap-1 sm:gap-2 mt-3 sm:mt-5 text-green-600 text-xs sm:text-sm font-medium">
//             <FaArrowUp /> {thisMonthLeads} this month
...
//           <div className="flex items-center justify-between">
//             <div>
//               <p className="text-xs sm:text-sm text-gray-500">Buy Requirements</p>
//               <h2 className="text-2xl sm:text-3xl font-bold mt-1 sm:mt-2 text-gray-800">{totalRequirements}</h2>
//             </div>
//             <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-green-100 flex items-center justify-center group-hover:scale-110 transition">
//               <FaEnvelope className="text-green-600 text-lg sm:text-2xl" />
//             </div>
//           </div>
//           <div className="mt-3 sm:mt-5 text-xs sm:text-sm text-gray-500 font-medium">Buyer requirements</div>
//         </div>

//         <div className={`rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-sm border hover:shadow-xl transition group ${plan.bg} ${plan.border}`}>
//           <div className="flex items-center justify-between">
//             <div>
//               <p className={`text-xs sm:text-sm font-medium ${plan.text}`}>Subscription</p>
//               <h2 className={`text-lg sm:text-2xl font-bold mt-1 sm:mt-2 capitalize ${plan.text}`}>
//                 {plan.icon} {profile?.subscriptionPlan || "No Plan"}
//               </h2>
//             </div>
//             <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-white/50 flex items-center justify-center group-hover:scale-110 transition">
//               <FaCrown className={`text-lg sm:text-2xl ${plan.text}`} />
//             </div>
//           </div>
//           <div className={`mt-3 sm:mt-5 text-xs font-medium ${plan.text}`}>
//             {profile?.subscriptionActive ? (
//               profile?.subscriptionExpire ? (
//                 `Expires: ${new Date(profile.subscriptionExpire).toLocaleDateString("en-IN")}`
//               ) : "Active"
//             ) : (
//               <Link to="/seller/subscription" className="underline">Upgrade Now →</Link>
//             )}
//           </div>
//         </div>
//       </div>
...
//           <div className="xl:col-span-2 bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-4 sm:p-6">
//             <h2 className="text-base sm:text-lg font-bold text-gray-800 mb-1">Products by Category</h2>
//             <p className="text-xs sm:text-sm text-gray-400 mb-4 sm:mb-5">Distribution across categories</p>
...
//             <h2 className="text-base sm:text-lg font-bold text-gray-800 mb-1">Product Status</h2>
//             <p className="text-xs sm:text-sm text-gray-400 mb-4 sm:mb-5">Approved vs Pending</p>
//             {pieData.length > 0 ? (
//               <ResponsiveContainer width="100%" height={200}>
//                 <PieChart>
...
//               <p className="text-xs sm:text-sm text-gray-500">Your latest added products</p>
//             </div>
//             <Link to="/seller/products" className="text-[#1447E6] font-medium text-xs sm:text-sm flex items-center gap-1 hover:gap-2 transition-all">
//               View All <FaChevronRight className="text-xs" />
//             </Link>
//           </div>
...
//                 key={f}
//                 onClick={() => setFilter(f)}
//                 className={`px-3 sm:px-4 py-1.5 rounded-xl text-xs font-semibold transition capitalize
//                   ${filter === f ? "bg-[#1447E6] text-white" : "bg-gray-100 text-gray-500 hover:bg-gray-200"}`}
//               >
//                 {f}
//               </button>
...
//                 <thead>
//                   <tr className="text-left border-b">
//                     <th className="pb-3 text-gray-500 font-medium pl-4 sm:pl-0">Product</th>
//                     <th className="pb-3 text-gray-500 font-medium hidden sm:table-cell">Category</th>
//                     <th className="pb-3 text-gray-500 font-medium">Status</th>
//                     <th className="pb-3 text-gray-500 font-medium">Price</th>
//                   </tr>
//                 </thead>
...
//                   {filteredProducts.map((p) => (
//                     <tr key={p._id} className="hover:bg-gray-50 transition">
//                       <td className="py-3 font-medium text-gray-800 pl-4 sm:pl-0">
//                         <div className="flex items-center gap-2 sm:gap-3">
//                           {p.images?.[0]?.url && (
//                             <img src={p.images[0].url} alt={p.title} className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl object-cover flex-shrink-0" />
//                           )}
//                           <span className="line-clamp-1 text-xs sm:text-sm">{p.title}</span>
//                         </div>
//                       </td>
//                       <td className="py-3 text-gray-500 text-xs sm:text-sm hidden sm:table-cell">{p.category?.name || "—"}</td>
//                       <td className="py-3">
//                         <span className={`px-2 sm:px-3 py-1 rounded-full text-xs font-semibold capitalize
...
//                         </span>
//                       </td>
//                       <td className="py-3 font-semibold text-gray-800 text-xs sm:text-sm">₹{p.price?.toLocaleString()}</td>
//                     </tr>
//                   ))}
//                 </tbody>
//               </table>
...
//               <Link to="/seller/add-product" className="w-full bg-[#1447E6] hover:bg-blue-700 text-white py-2.5 sm:py-3 rounded-2xl font-medium transition flex items-center justify-center gap-2 text-sm">
//                 <FaPlus /> Add New Product
//               </Link>
//               <Link to="/seller/leads" className="w-full bg-[#F54900] hover:bg-[#d63f00] text-white py-2.5 sm:py-3 rounded-2xl font-medium transition flex items-center justify-center gap-2 text-sm">
//                 <FaUsers /> View Leads
//               </Link>
//               <Link to="/seller/profile" className="w-full border border-gray-300 hover:border-[#1447E6] hover:text-[#1447E6] py-2.5 sm:py-3 rounded-2xl font-medium transition flex items-center justify-center gap-2 text-sm">
//                 Edit Profile
//               </Link>
//             </div>
//           </div>
...
//                   <Link to="/seller/leads" className="text-[#1447E6] text-xs font-medium">View All</Link>
//                 </div>
//                 {leads.length > 0 ? (
//                   <div className="space-y-2 sm:space-y-3">
//                     {leads.slice(0, 4).map((l, i) => (
//                       <div key={i} className="flex items-start gap-3 p-3 rounded-2xl bg-gray-50 hover:bg-blue-50 transition">
//                         <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-blue-100 flex items-center justify-center flex-shrink-0 text-blue-800 font-bold text-sm">
//                           {l.buyerName?.charAt(0).toUpperCase() || "B"}
//                         </div>
//                         <div className="min-w-0">
...
//                             {l.product?.title || l.productName || "—"}
//                           </p>
//                           <p className="text-xs text-gray-500">{l.buyerName} • {l.buyerPhone || "—"}</p>
//                         </div>
//                       </div>
//                     ))}
//                   </div>
...
//               <>
//                 <div className="flex items-center justify-between mb-3">
//                   <h2 className="text-sm font-bold text-gray-800">Buy Requirements</h2>
//                   <Link to="/seller/requirements" className="text-[#1447E6] text-xs font-medium">View All</Link>
//                 </div>
//                 {requirements.length > 0 ? (
//                   <div className="space-y-2 sm:space-y-3">
//                     {requirements.slice(0, 4).map((r, i) => (
//                       <div key={i} className="flex items-start gap-3 p-3 rounded-2xl bg-gray-50 hover:bg-green-50 transition">
//                         <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-green-100 flex items-center justify-center flex-shrink-0 text-green-800 font-bold text-sm">
//                           {r.buyerName?.charAt(0).toUpperCase() || "B"}
//                         </div>
//                         <div className="min-w-0">
//                           <p className="font-semibold text-gray-800 text-xs sm:text-sm line-clamp-1">{r.productName}</p>
//                           <p className="text-xs text-gray-500">{r.buyerName} • {r.location || "—"}</p>
//                         </div>
//                       </div>
//                     ))}
//                   </div>
...
//           {/* TIP BOX */}
//           <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl sm:rounded-3xl p-4 sm:p-6 text-white">
//             <h3 className="font-bold text-base sm:text-lg mb-2">Improve Your Sales 🚀</h3>
//             <p className="text-xs sm:text-sm text-orange-100 leading-relaxed">
//               Complete your profile and add more products to receive better buyer enquiries.
//             </p>
//             <Link to="/seller/profile" className="mt-3 sm:mt-4 inline-block bg-white text-orange-600 px-4 py-2 rounded-xl text-sm font-semibold hover:bg-orange-50 transition">
//               Complete Profile →
//             </Link>
//           </div>
//         </div>
...
const DashboardContent = () => {
  ...
  const totalLeads = leads.length;
  const totalRequirements = requirements.length;
  const totalAllLeads = totalLeads + totalRequirements;
    ...
    <main className="flex-1 p-4 sm:p-6 overflow-y-auto bg-gray-50">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-5 mb-6 sm:mb-8">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-sm border border-gray-100 hover:shadow-xl transition group">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm text-gray-500">Verify Leads</p>
              <h2 className="text-2xl sm:text-3xl font-bold mt-1 sm:mt-2 text-gray-800">{totalRequirements}</h2>
            </div>
            <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-green-100 flex items-center justify-center group-hover:scale-110 transition">
              <FaEnvelope className="text-green-600 text-lg sm:text-2xl" />
          ...
          <div className="mt-3 sm:mt-5 text-xs sm:text-sm text-gray-500 font-medium">Verify leads</div>
        </div>
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-sm border border-gray-100 hover:shadow-xl transition group">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold mt-1 sm:mt-2 text-gray-800">{totalAllLeads}</h2>
            </div>
            <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-purple-100 flex items-center justify-center group-hover:scale-110 transition">
              <FaEye className="text-purple-600 text-lg sm:text-2xl" />
            </div>
          </div>
          <div className="flex items-center gap-1 sm:gap-2 mt-3 sm:mt-5 text-purple-600 text-xs sm:text-sm font-medium">
            {totalLeads} inquiries + {totalRequirements} verify
          </div>
        </div>
        ...
        <div className="space-y-4 sm:space-y-5">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-4 sm:p-6">
            ...
            {activeTab === "requirements" && (
              <>
                <div className="flex items-center justify-between mb-3">
                  <h2 className="text-sm font-bold text-gray-800">Verify Leads</h2>
                  <Link to="/seller/leads" className="text-[#1447E6] text-xs font-medium">View All</Link>
                </div>
                {requirements.length > 0 ? (
                  <div className="space-y-2 sm:space-y-3">
