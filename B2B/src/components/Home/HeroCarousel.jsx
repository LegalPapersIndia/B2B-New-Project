...
//   return (
//     <section
//       className="relative w-full h-[480px] sm:h-[560px] lg:h-[70vh] rounded-3xl overflow-hidden shadow-xl bg-black"
//       onMouseEnter={() => setIsPaused(true)}
//       onMouseLeave={() => setIsPaused(false)}
//     >
//       {/* IMAGES */}
...
//             }}
//           >
//             {/* Overlay — lighter ab, kyunki background image khud light hai */}
...
//       {/* CONTENT */}
//       <div className="relative z-10 h-full flex flex-col justify-center px-5 sm:px-10 lg:px-14 text-white">

//         {/* Badge */}
//         <div className="mb-4 sm:mb-5">
//           <span className="px-4 sm:px-5 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-[10px] sm:text-xs md:text-sm tracking-widest font-medium">
//           LPI-B2B MARKETPLACE 
//           </span>
//         </div>
...
//           animate={{ opacity: 1, y: 0 }}
//           transition={{ duration: 0.7 }}
//           className="font-poppins text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[2.75rem] font-bold leading-snug sm:leading-tight max-w-3xl tracking-tight"
//         >
//           {slides[current].title}
//         </motion.h1>
...
//           animate={{ opacity: 1, y: 0 }}
//           transition={{ delay: 0.15, duration: 0.7 }}
//           className="font-poppins mt-3 sm:mt-5 text-gray-200 text-xs sm:text-sm md:text-base lg:text-lg max-w-xl sm:max-w-2xl leading-relaxed"
//         >
//           {slides[current].subtitle}
//         </motion.p>
...
//           <Link
//             to="/"
//             className="font-poppins bg-[#F54900] hover:bg-orange-700 transition px-6 sm:px-8 py-3 sm:py-4 rounded-2xl font-semibold text-sm sm:text-base text-center shadow-lg"
//           >
//             Explore Products
//           </Link>
...
//           <Link
//             to="/register"
//             className="font-poppins bg-white/10 hover:bg-white/20 border border-white/30 transition px-6 sm:px-8 py-3 sm:py-4 rounded-2xl font-semibold text-sm sm:text-base text-center"
//           >
//             Become a Seller
//           </Link>
//         </motion.div>
...
// B2B/src/Components/HeroCarousel.jsx
import React, { useState, useEffect } from "react";
import { Link } from "react-router-dom";
...
const HeroCarousel = () => {
  ...
  if (loading) {
    return (
      <section className="relative w-full h-[480px] sm:h-[560px] lg:h-[70vh] rounded-3xl overflow-hidden shadow-xl bg-black flex items-center justify-center">
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-5 sm:px-10 lg:px-14 text-white">
        ...
        {/* TITLE */}
       <motion.h1
  key={slides[current]._id + "_title"}
  initial={{ opacity: 0, y: 25 }}
  animate={{ opacity: 1, y: 0 }}
  transition={{ duration: 0.7 }}
  className="font-poppins text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[2.75rem] font-bold leading-snug sm:leading-tight max-w-3xl tracking-tight text-white"
>
  {slides[current].title}
</motion.h1>
        ...
        {/* SUBTITLE */}
        <motion.p
          key={slides[current]._id + "_subtitle"}
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.15, duration: 0.7 }}
          className="font-poppins mt-3 sm:mt-5 text-gray-200 text-xs sm:text-sm md:text-base lg:text-lg max-w-xl sm:max-w-2xl leading-relaxed"
