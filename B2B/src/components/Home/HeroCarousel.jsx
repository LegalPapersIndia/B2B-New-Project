...
//   return (
//     <section
//       className="relative w-full h-[520px] sm:h-[600px] lg:h-[70vh] rounded-3xl overflow-hidden shadow-xl"
...
//             {/* SUBTITLE */}
//             <p className="mt-5 text-gray-200 text-sm sm:text-lg max-w-2xl">
