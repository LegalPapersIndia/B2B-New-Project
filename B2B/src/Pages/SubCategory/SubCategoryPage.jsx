...
//                     const detailsUrl = `/category/${categorySlug}/subcategory/${subcategorySlug}/product/${product.slug}`; // ✅ NEW

//                     return (
//                       <div
//                         key={product._id}
//                         onClick={() => navigate(detailsUrl)} // ✅ NEW - poora card clickable
//                         className="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-lg transition duration-300 cursor-pointer" // ✅ UPDATED - added cursor-pointer
//                       >
...
//                           {/* ✅ UPDATED - company name ab seller profile ka clickable link hai */}
//                           {product.seller?._id ? (
//                             <Link
//                               to={`/seller/${product.seller._id}`}
//                               onClick={(e) => e.stopPropagation()} // ✅ NEW - card ke onClick se navigate double na ho
//                               className="mt-1 block text-sm font-medium text-slate-600 hover:text-blue-800 hover:underline w-fit"
//                             >
          ...
          <div className="lg:col-span-3">
            ...
            {!loading && !error && (
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                {filteredProducts.length > 0 ? (
                  filteredProducts.map((product) => {
                    const detailsUrl = `/category/${categorySlug}/subcategory/${subcategorySlug}/product/${product.slug}`; 
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="p-3">
                          <h2 className="font-semibold text-gray-900 text-sm line-clamp-1">{product.title}</h2>
                          ...
                          {product.seller?._id ? (
                            <Link
                              ...
                              className="mt-1 block text-xs font-medium text-slate-600 hover:text-blue-800 hover:underline w-fit"
                            >
                              {product.seller?.companyName || product.seller?.name || "—"}
                            </Link>
                          ) : (
                          ...
                          <p className="text-blue-800 font-semibold mt-2 text-sm">
                            ₹{product.price?.toLocaleString()}
                            <span className="text-gray-400 text-xs font-normal ml-1">/ {product.unit}</span>
                          </p>
                          <p className="text-xs text-gray-400 mt-1">MOQ: {product.moq} {product.unit}</p>
                          ...
                          <div className="flex flex-col sm:flex-row gap-2 mt-3">
                            <Link
                              ...
                              onClick={(e) => e.stopPropagation()} 
                            >
                              <button className="w-full bg-blue-800 hover:bg-blue-900 text-white py-2 rounded-xl text-xs font-medium transition">
                                View Details
                              </button>
                            </Link>
                            <button
                              ...
                              className="flex-1 border border-blue-800 text-blue-800 hover:bg-blue-50 py-2 rounded-xl text-xs font-medium transition"
                            >
                              Send Inquiry
                            </button>
                          </div>
