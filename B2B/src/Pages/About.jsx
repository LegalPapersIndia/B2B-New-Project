  ...
  const coreValues = [
    {
      ...
      desc: "Every supplier goes through strict verification for safe, trustworthy B2B transactions.",
    },
    {
      icon: <FaRocket />,
      title: "Fast Growth",
      desc: "Smart sourcing tools that help your business scale quicker and smarter.",
    },
    {
      icon: <FaHandshake />,
      title: "Strong Partnerships",
      desc: "We build lasting relationships that connect buyers and sellers globally.",
    },
    {
      icon: <FaAward />,
      title: "Award-Winning Platform",
      desc: "Recognized for excellence and innovation in the B2B trade ecosystem.",
    },
  ];
  ...
  return (
    <div className="bg-[#f8fafc] overflow-hidden">
      ...
      <section className="pb-16 sm:pb-24 relative">
        ...
        {/* FLOATING BLUR - decorative */}
        <div className="absolute top-10 right-0 w-72 h-72 bg-orange-500/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 text-lg mt-5 max-w-3xl mx-auto">
              We're built on trust, speed, and partnership — the values that
              drive every business connection on our platform.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {coreValues.map((item, index) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="group relative bg-white rounded-3xl p-8 border border-slate-100 shadow-md hover:shadow-2xl transition-all duration-500 hover:border-orange-200 overflow-hidden"
              >
                ...
                <motion.div
                  ...
                  className="w-16 h-16 rounded-2xl bg-orange-100 group-hover:bg-orange-500 flex items-center justify-center text-orange-500 group-hover:text-white text-3xl transition-colors duration-500"
                >
                  {item.icon}
                </motion.div>
                ...
                <span className="absolute bottom-0 left-0 h-1 w-0 bg-orange-500 group-hover:w-full transition-all duration-500 rounded-full" />
      ...
      {/* ================= CTA ( UPDATED - responsive + redirect added) ================= */}
      <section className="py-16 sm:py-20 bg-gradient-to-r from-blue-600 to-orange-600 text-white text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          {/*  UPDATED - onClick redirect + responsive sizing */}
          <motion.button
            whileHover={{
              scale: 1.05,
            }}
            ...
            className="w-full sm:w-auto bg-white text-orange-600 px-8 py-4 sm:px-12 sm:py-5 rounded-2xl font-bold text-base sm:text-xl shadow-xl hover:shadow-2xl transition-all"
          >
            Get Started Now — It's Free
          </motion.button>
