...
export default function FilterSidebar({
    ...
    const fetchSubCategories = async () => {
      try {
        ...
        const filteredSubCategories = subcategories.filter(
          (item) => item.category?.slug?.toLowerCase() === slug?.toLowerCase()
        );
  ...
  // NEW - MOQ input handler
  const handleMoqChange = (e) => {
    const val = Number(e.target.value);
    setMoqFilter(val < 0 ? 0 : val);
  };
    ...
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm lg:sticky lg:top-24 overflow-hidden">
      ...
      <div className="p-4 space-y-5">
        ...
        <div>
          ...
          <div className="space-y-1.5 max-h-64 overflow-y-auto pr-1">
            {!loadingSubCategories && relatedCategories.length > 0 ? (
              relatedCategories.map((item) => (
                <Link
                  key={item._id}
                  to={`/category/${slug}/subcategory/${item.slug}`}
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1">
              ...
              <div className="flex items-center border border-gray-200 rounded-lg px-2 focus-within:border-[#F54900]">
                ...
                <input
                  ...
                  className="w-full px-1.5 py-2 text-[13px] outline-none"
                />
              </div>
            </div>
