...
//               connect with buyers, receive inquiries,
        ...
        <div className="relative hidden lg:flex flex-col justify-center bg-blue-900 text-white px-14 py-10 overflow-hidden">
          ...
          >
            ...
            <div className="mt-8 space-y-4">
              {[
                "Email ya Phone se login karein",
                "Secure & Verified Platform",
                "Manage Your Products & Leads",
        ...
        <div className="p-8 md:p-10 lg:p-12">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* HELPER TEXT */}
              <p className="text-xs text-gray-400 -mt-2 pl-2 flex items-center gap-1">
                <Phone className="w-3 h-3" />
                You can login with your email or 10-digit mobile number
              </p>
